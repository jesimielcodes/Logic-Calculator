...
welcome_label = Label(text="      simple logicalc", bg="#808080", font=("Trebuchet Ms", 15, "bold"), fg="#FFFFFF")
welcome_label.place(x=130, y=25)

bg_label = Label(root, image=image, bg="#808080")
bg_label.place(x=130, y=65)

progress_label = Label(root, text="Loading...", font=("Trebuchet Ms", 13, "bold"), fg="#FFFFFF", bg="#808080")
